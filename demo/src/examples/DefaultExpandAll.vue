  ...
  <q-card :class="!$q.dark.isActive?'my-lg q-pa-md q-ma-sm bg-grey-2':'my-lg q-pa-md q-ma-sm bg-grey-8'">
    <q-toolbar>
      ...
      >
        ...
        ><span class="ellipsis">Default Expand All</span></q-toolbar-title>
      </q-ribbon>
    </q-toolbar>
    ...
    <q-card-section>
      <q-hierarchy dense :columns="columns" :data="data" :classes="classes" :dark="dark" :default-expand-all="true"></q-hierarchy>
    </q-card-section>
  </q-card>
</template>
